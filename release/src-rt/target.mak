...
export RT-AC68U_BASE := IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
			...
			NANO=y OPENSSL11=y NTPD=y NETOOL=y TRACEROUTE=n
...
export HND-94908_BASE := HND_ROUTER=y PROFILE="94908HND" SW_HW_AUTH=y AMAS=y UTF8_SSID=y ETHOBD=y DWB=y SAMBA3="3.6.x" \
			 CONNDIAG=y OOKLA=y WL_SCHED_V3=y
...
export RT-AC86U += BUILD_NAME="RT-AC86U" NVSIZE="128" DHDAP=y DPSTA=y LACP=n WTFAST=y REPEATER=y \
				...
				TEMPROOTFS=n SSH=y FRS_FEEDBACK=n SYSSTATE=y ROG=y STAINFO=y CLOUDCHECK=n NATNL_AICLOUD=y \
				...
				HD_SPINDOWN=y NATNL_AIHOME=y ASPMD=n BCM_MEVENT=y UUPLUGIN=y IPV6S46=y \
				IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV DFS_US=y ALEXA=n IFTTT=n \
				OPEN_NAT=y SW_CTRL_ALLLED=y AHS=n ASD=y FRS_LIVE_UPDATE=n INSTANT_GUARD=y PC_SCHED_V3=y GAME_MODE=y \
				BCMEVENTD=y BCM_APPEVENTD=y JFFS_NVRAM=y LETSENCRYPT=y WIREGUARD=y \
				VISUALIZATION=y NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y
...
export GT-AC2900 += BUILD_NAME="GT-AC2900" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
				IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EMAIL=y FRS_LIVE_UPDATE=n \
				EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=y \
				SMARTSYNCBASE=y USB="USB" APP="installed" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y \
				DISK_MONITOR=y BTN_WIFITOG=y OPTIMIZE_XBOX=y ODMPID=y LED_BTN=y BCMSMP=y \
				...
				TEMPROOTFS=n SSH=y FRS_FEEDBACK=n SYSSTATE=y ROG=y STAINFO=y CLOUDCHECK=n NATNL_AICLOUD=y \
				REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y WLCLMLOAD=n BCM_MUMIMO=y NVRAM_ENCRYPT=y \
				LAN50=all ATCOVER=y GETREALIP=y CFEZ=y TFAT=y NTFS="tuxera" HFS="tuxera" IPV6S46=y \
				NEWSSID_REV4=y LAN4WAN_LED=n NEW_APP_ARM=y NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=n \
				HD_SPINDOWN=y NATNL_AIHOME=y ASPMD=n BCM_MEVENT=y UUPLUGIN=y BONDING=y GOOGLE_ASST=y \
				IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV ALEXA=y IFTTT=y VPN_FUSION=n \
				OPEN_NAT=y SW_CTRL_ALLLED=y AHS=n ASD=y INSTANT_GUARD=y GAME_MODE=y \
				BCMEVENTD=y BCM_APPEVENTD=y JFFS_NVRAM=y LETSENCRYPT=y BW160M=y \
				RGBLED=y I2CTOOLS=y BTN_TURBO=y ROG_UI=n GEFORCENOW=y AVBLCHAN=y WIREGUARD=y \
				VISUALIZATION=y NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y
...
export RT-AX88U += BUILD_NAME="RT-AX88U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		...
		AMASDB=n CRASHLOG=y WATCH_REINIT=n AVBLCHAN=y BW160M=y DWB=y BONDING_WAN=y BRCM_HOSTAPD=y UUPLUGIN=y IPERF3=y \
		HSPOT=y INTERNETCTRL=y AMAZON_WSS=y OPEN_NAT=y CAPTCHA=y SW_CTRL_ALLLED=y GAME_MODE=y CFGSYNC_LOCSYNC=y INSTANT_GUARD=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y
...
export GT-AX11000 += BUILD_NAME="GT-AX11000" EXT_PHY="BCM84880" SWITCH2="" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		...
		BCM_CEVENTD=y UTF8_SSID=y RGBLED=y AURASYNC=y I2CTOOLS=y AMAS=y DBLOG=y ETHOBD=y CONNDIAG=y WIREGUARD=y \
...
export RT-AX58U += BUILD_NAME="RT-AX58U" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		...
		ACL96=y GOOGLE_ASST=y COMFW=n WIREGUARD=y IPV6S46=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y
...
export RT-AX56U += BUILD_NAME="RT-AX56U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		...
		BCM_CEVENTD=y UTF8_SSID=y AMAS=y DWB=y DBLOG=y ETHOBD=y CRASHLOG=y WATCH_REINIT=n BW160M=n \
		BRCM_HOSTAPD=y UUPLUGIN=n IPERF3=y INFO_EXAP=y FRS_LIVE_UPDATE=n AVBLCHAN=y INSTANT_GUARD=y AHS=n ASD=y \
		ACL96=y GOOGLE_ASST=y ASUSCTRL=y WIREGUARD=y IPV6S46=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y
...
export RT-AX86U += BUILD_NAME="RT-AX86U" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y HND_WL=y \
		...
		VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y NOTIFICATION_CENTER=y BWDPI=y MOSQUITTO=y \
		...
		DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y CRASHLOG=y BW160M=y \
		BRCM_HOSTAPD=y IPERF3=y FRS_LIVE_UPDATE=n BCN_RPT=y BTM_11V=y INFO_EXAP=y \
		AVBLCHAN=y OPEN_NAT=y SW_CTRL_ALLLED=y INSTANT_GUARD=y \
		ACL96=y GOOGLE_ASST=y EXTEND_LIMIT=y ASUSCTRL=y WIREGUARD=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y
...
export RT-AX68U += BUILD_NAME="RT-AX68U" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		...
		WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="installed" PROXYSTA=y DNSMQ=y BCMWL6=y BCMWL6A=y DISK_MONITOR=y \
		...
		ACL96=y GOOGLE_ASST=y ASUSCTRL=y WIREGUARD=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y
...
export RT-AC68U_V4 += BUILD_NAME="RT-AC68U_V4" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
                      AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y \
                      WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="installed" PROXYSTA=y DNSMQ=y BCMWL6=y BCMWL6A=y \
                      ...
                      NFS=y DNSFILTER=y SNMPD=n TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y DNSPRIVACY=y VISUALIZATION=y

export GT-AXE11000 := $(HND-962118_BASE) ETLAN_LED=y I2CTOOLS=y GEFORCENOW=y APFS="tuxera"
export GT-AXE11000 += BUILD_NAME="GT-AXE11000" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=y WTFAST=y REPEATER=y IPV6SUPP=y \
                      HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y \
                      PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="installed" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y \
                      ...
                      STAINFO=y CLOUDCHECK=n NATNL_AICLOUD=y REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y WLCLMLOAD=n \
                      BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y CFEZ=y ETLAN_LED=y NEWSSID_REV6=y NEW_APP_ARM=y \
                      ...
                      BCN_RPT=y BTM_11V=y INTERNETCTRL=y ASD=y AHS=n FRS_LIVE_UPDATE=n HAS_5G_2=y CAPTCHA=y WIFI6E=y OUTFOX=y \
                      GAME_MODE=y AMAS_ETHDETECT=y INSTANT_GUARD=y AVBLCHAN=y FRONTHAUL_DWB=y OWE_TRANS=y HSPOT=y ACL96=y \
                      GOOGLE_ASST=y EXTEND_LIMIT=y \
